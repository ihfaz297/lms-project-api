  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Welcome to LearnHub. Please set up your bank information.',
      });
      navigate('/bank');
    } catch (error) {
      toast({
    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Join LearnHub and start your journey</CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <RadioGroup value={role} onValueChange={(v) => setRole(v as 'learner' | 'instructor')}>
                <div className="flex items-center space-x-3 p-3 rounded-lg border hover:bg-muted/50 transition-colors cursor-pointer">
                  ...
                  <Label htmlFor="learner" className="flex items-center gap-2 cursor-pointer flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Enroll in courses and get certified</p>
                    </div>
                  </Label>
                </div>
                <div className="flex items-center space-x-3 p-3 rounded-lg border hover:bg-muted/50 transition-colors cursor-pointer">
                  ...
                  <Label htmlFor="instructor" className="flex items-center gap-2 cursor-pointer flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Create courses and earn money</p>
                    </div>
                  </Label>
                </div>
              </RadioGroup>
